...
/* 難易度で変えるもの、変えないもの（GDD 13.2）。

   もとは世界の速さを一律に上げ下げしていた。他家の内政・攻めの頻度・調略の
   頻度をまとめて掛けるので、易しくすると盤が固まらず、難しくすると三十年で
   巨大勢力ばかりの別のゲームになる。難易度で世界の姿が変わってしまう。

   世界の道理――大名の器量が家の色を決めること、弱い家が外交で身を守ること、
   大身が弱きから呑むこと――は、どの難易度でも同じである。易しいから道理が
   緩む、というのは筋が通らない。

   難易度で変えるのは二つ。

     一　采配の切れ味（aiSharp）… 的をどれだけ正しく選べるか。易しければ二番手
         三番手の城へ向かい、好機を逃す。難しければ最も値打ちのある城を選ぶ。
     二　遊ぶ側への当たり（aiVsPlayer）… 諸家が遊ぶ側の城をどれだけ重く見るか。
         難しければ寄ってたかって狙い、易しければ見逃す。

   世界の速さ（aiGrow・aiEager・aiNeed・aiPlot）にも幅は残すが、狭くする。
   易でも盤は健全に動き、難でも世界の形は大きく変わらない。 */
export const LEVELS = {
  易: {
    name: "易", desc: "他家は的を選び損ね、こちらを狙うことも少ない。まず仕組みを覚えたいときに。",
    aiGrow: 0.8,        // 他家の内政の効き
    aiEager: 0.85,      // 他家が攻めに出る頻度
    aiNeed: 1.20,       // 攻めに要する兵力の比
    aiPlot: 0.6,        // 他家の調略の頻度
    aiSharp: 0.45,      // 最も値打ちのある的を選ぶ確かさ
    aiVsPlayer: 0.75,   // 遊ぶ側の城をどれだけ重く見るか
    reliefP: 1.25,      // こちらへの後詰の来やすさ
    tribute: 1.2,       // こちらの収入
  },
  普通: {
    name: "普通", desc: "この時代のありようをそのまま。",
    aiGrow: 1, aiEager: 1, aiNeed: 1.05, aiPlot: 1,
    aiSharp: 0.8, aiVsPlayer: 1, reliefP: 1, tribute: 1,
  },
  難: {
    name: "難", desc: "他家は的を過たず、隙あらばこちらへ寄ってくる。謀も絶えぬ。",
    aiGrow: 1.2, aiEager: 1.15, aiNeed: 0.95, aiPlot: 1.8,
    aiSharp: 1, aiVsPlayer: 1.6, reliefP: 0.8, tribute: 0.88,
  },
};
